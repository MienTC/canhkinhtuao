      ...
      <div className="container-custom">
        ...
        <div className="relative rounded-sm overflow-hidden bg-brand-dark p-12 md:p-20 text-center shadow-2xl">
          ...
          <div className="relative z-10">
            ...
            >
              <span className="text-brand-green font-black text-[10px] uppercase tracking-[0.4em]">Hotline: 0985 795 552</span>
            </motion.div>
            ...
            <div className="flex flex-wrap justify-center gap-6">
              <Button className="h-16 px-12 group">
                GỌI NGAY: 0985 795 552 <ChevronRight className="ml-2 group-hover:translate-x-2 transition-transform" />
              </Button>
